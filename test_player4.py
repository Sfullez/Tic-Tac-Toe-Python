...
class Player4TestCase(unittest.TestCase):
    def setUp(self):
    ...
    def testGame(self):
        ...
        self.client_socket.send('register User_14 mypassword\r\n')
        ...
        self.client_socket.send('ready\r\n')
        self.assertEqual(self.receive(),
                         "It's your turn, you are 'O'. Please send the number of the corresponding box.\nX|2|3\n4|5|6\n7|8|9\n")
